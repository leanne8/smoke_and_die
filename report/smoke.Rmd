...
read_chunk("../code/exportimages.R")
```

The causal relation between cigarette smoking and lung cancer has been a field of wide interest and extensive research for many organizations and individuals. In this particular project, we plan to establish the relationship between cigarette smoking and lung cancer. 
...
In it, we see that Utah, which had the lowest smoking population percentage, also has the lowest percentage of lung cancer patients among all the states. Kentucky has has the highest rate of lung cancer patients followed by West Virginia which had the highest cigarette smoking population percentage.
